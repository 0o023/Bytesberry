...
import ProductDetails from './area/Tealio_admin/ProductDetail';
import ProductDetailsForm from './area/Tealio_admin/ProductDetailForm';
...
const App = () => {
  ...
  const updateVariant = (updatedVariant) => {
    setVariants(variants.map((variant) =>
      variant.id === updatedVariant.id && variant.name === updatedVariant.name
        ? updatedVariant
        : variant
    ));
  };

  const deleteVariant = (productId, variantName) => {
    setVariants(variants.filter((variant) =>
      !(variant.productId === productId && variant.name === variantName)
    ));
  };
            ...
            <Route
              ...
              element={
                <ProductVariants
                  products={products}
                  variants={variants}
                  onEdit={(productId, variantName) => navigate(`/variants/edit/${productId}/${variantName}`)}
      ...
      <div className="App">
        ...
        <div className="content">
          <Routes>
           ...
           <Route
          path="/detais/edit/:id"
          element={<ProductDetailsForm products={products} updateProduct={updateProduct} />}
        />
           <Route
              path="/inventory"
              element={<ProductInventory />}
