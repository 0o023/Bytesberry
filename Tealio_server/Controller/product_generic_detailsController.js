...
const { addProductCompleteDetailsValidation } = require('../Schemas/product_generic_details.schema'); // Assuming the validation file is named productValidations.js

const addProductCompleteDetails = async (productName, productDescription, productImages) => {
    // Validate the inputs
    const { error } = addProductCompleteDetailsValidation.validate({
...
module.exports = { addProductCompleteDetails, 
    updateProductGenericDetails, deleteProductGenericDetails, 
